    ...
    public MonitorReportDescriptor() 
     {
        ...
        //-- _serviceList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.kaartenbalie.reporting.castor.Service.class, "_serviceList", "service", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    MonitorReport target = (MonitorReport) object;
                    target.addService( (nl.b3p.kaartenbalie.reporting.castor.Service) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.kaartenbalie.reporting.castor.Service();
            }
        };
        desc.setHandler(handler);
