...
/**
 * Class ResponseTimeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ResponseTimeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResponseTimeDescriptor() 
     {
        super();
        xmlName = "response-time";
        ...
        //-- validation code for: _durationLow
        ...
        //-- validation code for: _durationHigh
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            LongValidator typeValidator = new LongValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.kaartenbalie.reporting.castor.ResponseTimeDescriptor()
    ...
    {
        return nl.b3p.kaartenbalie.reporting.castor.ResponseTime.class;
